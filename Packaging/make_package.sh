...
#
# An archive with the wrong layout does not fail loudly: Slicer copies whatever
# it finds, records the extension as installed, and the module simply never
# appears.  A second attempt with the right archive is then refused as "already
# installed" until the first one is uninstalled.
#
# Usage:
